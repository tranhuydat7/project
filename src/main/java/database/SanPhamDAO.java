...
public class SanPhamDAO implements DAOInterface<SanPham> {
	...
	public ArrayList<SanPham> getSanPhamByDanhMuc(String tenDanhMuc) {
		ArrayList<SanPham> ketQua = new ArrayList<SanPham>();
		try {
			// bước 1: kết nối đến csdl
			Connection con = JDBCUtil.getConnection();
	...
	public ArrayList<SanPham> getSanPhamByKey(String keySearch) {
		ArrayList<SanPham> ketQua = new ArrayList<SanPham>();
		try {
			// bước 1: kết nối đến csdl
			Connection con = JDBCUtil.getConnection();
			// bước 2: tạo đối tượng statement
			String sql = "SELECT * FROM sanpham where tensanpham like ? or madanhmuc like ?";
			PreparedStatement pst = con.prepareStatement(sql);
			pst.setString(1, '%' + keySearch + '%');
			pst.setString(2, '%' + keySearch + '%');
	...
	public ArrayList<SanPham> sapXepTheoVan(String tenDM) {
		ArrayList<SanPham> ketQua = new ArrayList<SanPham>();
		try {
			// bước 1: kết nối đến csdl
			Connection con = JDBCUtil.getConnection();
			// bước 2: tạo đối tượng statement
			String sql = "SELECT * FROM sanpham where madanhmuc= ? order by tensanpham asc";
			PreparedStatement pst = con.prepareStatement(sql);
	...
	public ArrayList<SanPham> sapXepTheogiaGiam(String tenDM) {
		ArrayList<SanPham> ketQua = new ArrayList<SanPham>();
		try {
			// bước 1: kết nối đến csdl
			Connection con = JDBCUtil.getConnection();
			// bước 2: tạo đối tượng statement
			String sql = "SELECT * FROM sanpham where madanhmuc= ? order by giaban desc";
			PreparedStatement pst = con.prepareStatement(sql);
			pst.setString(1, tenDM);
