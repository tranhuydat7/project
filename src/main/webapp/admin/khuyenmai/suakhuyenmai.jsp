		...
		<div class="col-9 container">
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">Sửa khuyến mại</li>
				</ol>
			</nav>
			<%
			...
			<form action="<%=url%>/khuyen-mai-admin-controller" method="get">
				<input type="hidden" name="hanhDong" value="save-khuyen-mai" />

				<div class="mb-3">
					<label for="maKhuyenMai" class="form-label">Mã khuyến mại<span
						class="red">*</span></label> <input type="text" class="form-control"
						id="maKhuyenMai" name="maKhuyenMai"
						value="<%=khuyenMai.getMaKhuyenMai()%>"
						placeholder="Nhập mã khuyến mại" required>
				</div>
				<div class="mb-3">
					<label for="tenKhuyenMai" class="form-label">Tên khuyến mại<span
						class="red">*</span></label> <input type="text" class="form-control"
						id="tenKhuyenMai" name="tenKhuyenMai"
						value="<%=khuyenMai.getTenKhuyenMai()%>"
						placeholder="Nhập tên khuyến mại" required>
				</div>
				<div class="mb-3">
					<label for="giamGiaTu" class="form-label">Giảm giá từ <span
						class="red">*</span></label> <input type="number" min="1"
						class="form-control" id="giamGiaTu" name="giamGiaTu"
						value="<%=khuyenMai.getGiamGiaTu()%>" placeholder="Giảm giá từ"
						required>
				</div>
				<div class="mb-3">
					<label for="giamGiaMax" class="form-label">Giảm giá tối đa
						<span class="red">*</span>
					</label> <input type="number" min="1" class="form-control" id="giamGiaMax"
						name="giamGiaMax" value="<%=khuyenMai.getGiamGiaMax()%>"
						placeholder="Giảm giá tối đa" required>
				</div>
				<div class="mb-3">
					<label for="giamGiaPhanTram" class="form-label">Giảm giá
						phần trăm <span class="red">*</span>
					</label> <input type="number" min="1" class="form-control"
						id="giamGiaPhanTram" name="giamGiaPhanTram"
						value="<%=khuyenMai.getGiamPhanTram()%>"
						placeholder="Giảm giá phần trăm" required>
				</div>
				<div class="mb-3">
					<label for="ngayBatDau" class="form-label">Ngày bắt đầu <span
						class="red">*</span></label> <input type="date"
						value="<%=khuyenMai.getNgayBatDau()%>" class="form-control"
