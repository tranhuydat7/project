			...
			<div>
				<div class="row">
					<div class="col-auto me-auto">
						<form class="d-flex" action="<%=url%>/san-pham-admin-controller"
				...
				<table class="table">
					...
					<tbody class="table-group-divider">
						...
						<tr>
							...
							<td><%=sanPham.getGiaGoc()%></td>
							<td><%=sanPham.getSoLuong()%></td>
							<td><%=sanPham.getDanhMuc().getMaDanhMuc()%></td>
							<td><%=sanPham.getMauSac().getMaMau()%></td>
							<td><%=sanPham.getKichCo().getMaKichCo()%></td>
							<td><a
								href="<%=url%>/san-pham-admin-controller?hanhDong=sua-san-pham&maSanPham=<%=sanPham.getMaSanPham()%>">
									<i class="bi bi-pencil"></i>
							</a> <a
								href="<%=url%>/san-pham-admin-controller?hanhDong=xoa-san-pham&maSanPham=<%=sanPham.getMaSanPham()%>"><i
				...
				<nav aria-label="Page navigation example">
					<ul class="pagination justify-content-end">
						...
						<li class="page-item"><a class="page-link"
							href="<%=url%>/san-pham-admin-controller?hanhDong=list&index=<%=index%>"><%=index%></a></li>
