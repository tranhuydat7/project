			...
			<div>
				<div class="row">
					...
					<div class="col-auto">
						<a class="btn btn-primary"
							href="<%=url%>/admin/khuyenmai/themkhuyenmai.jsp">Thêm khuyến
							mại</a>
					</div>
				...
				<table class="table">
					...
					<tbody class="table-group-divider">
						<%
						int i = 1;
						List<KhachHang> khachHangList = (ArrayList) request.getAttribute("khachHangList");
						%>
						<%
						...
						<tr>
							...
							<td><%=khachHang.getHoVaTen()%></td>
							<td><%=khachHang.getGioiTinh()%></td>
							<td><%=khachHang.getEmail()%></td>
							<td><%=khachHang.getSoDienThoai()%></td>
							<td><%=khachHang.getNgaySinh()%></td>
							<td><a
								href="<%=url%>/user-admin-controller?hanhDong=sua-user&maKhachHang=<%=khachHang.getMaKhachHang()%>">
									<i class="bi bi-pencil"></i>
							</a> <a
								href="<%=url%>/user-admin-controller?hanhDong=xoa-user&maKhachHang=<%=khachHang.getMaKhachHang()%>"><i
