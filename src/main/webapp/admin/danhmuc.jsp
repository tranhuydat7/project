	...
	<div class="row">
		<div class="col-3">
			<ul class="nav flex-column">
				...
				<li class="nav-item"><a class="nav-link"
					href="<%=url%>/mau-sac-admin-controller?hanhDong=list&index=1">Màu sắc</a></li>
				<li class="nav-item"><a class="nav-link"
					href="<%=url%>/kich-co-admin-controller?hanhDong=list&index=1">Kích cỡ</a></li>
				<li class="nav-item"><a class="nav-link"
			...
			<div>
				<div class="row">
					<div class="col-auto me-auto">
						<form class="d-flex" action="<%=url%>/danh-muc-admin-controller"
					...
					<div class="col-auto">
						<a class="btn btn-primary" href="<%=url%>/admin/themdanhmuc.jsp">Thêm
							danh mục</a>
					</div>
				...
				<table class="table">
					...
					<tbody class="table-group-divider">
						<%
						int i = 1;
						List<DanhMuc> listsDanhMucs = (ArrayList<DanhMuc>) request.getAttribute("listDanhMuc");
						%>
						<%
						for (DanhMuc danhMuc : listsDanhMucs) {
						%>
						<tr>
							<th scope="row">
								<div class="form-check">
							...
							<td><%=danhMuc.getDanhMucCha().getMaDanhMuc()%></td>
							<td><a
								href="<%=url%>/danh-muc-admin-controller?hanhDong=sua-danh-muc&maDanhMuc=<%=danhMuc.getMaDanhMuc()%>">
									<i class="bi bi-pencil"></i>
							</a> <a
								href="<%=url%>/danh-muc-admin-controller?hanhDong=xoa-danh-muc&maDanhMuc=<%=danhMuc.getMaDanhMuc()%>"><i
				...
				<nav aria-label="Page navigation example">
					<ul class="pagination justify-content-end">
						...
						%>
						<li class="page-item"><a class="page-link" href="<%=url%>/danh-muc-admin-controller?hanhDong=list&index=<%=index %>"><%=index%></a></li>
