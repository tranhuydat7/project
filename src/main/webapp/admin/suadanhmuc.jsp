	...
	<div class="row">
		...
		<div class="col-9 container">
			...
			<form action="<%=url%>/danh-muc-admin-controller" method="get">
				<input type="hidden" name="hanhDong" value="save-danh-muc" />
				<div>
					<label for="maDanhMuc" class="form-label">Mã danh mục</label> <input
						type="text" class="form-control" id="maDanhMuc" name="maDanhMuc"
				...
				<div class="mb-3">
					<label for="tenDanhMuc" class="form-label">Tên danh mục</label> <input
						type="text" class="form-control" id="tenDanhMuc" name="tenDanhMuc"
						value="<%=danhMuc.getTenDanhMuc()%>">
				</div>
				<div class="mb-3">
					<label for="danhMucCha" class="form-label">Danh mục cha</label> <input
						type="text" class="form-control" id="danhMucCha" name="danhMucCha"
						value="<%=danhMuc.getDanhMucCha().getMaDanhMuc()%>">
				</div>
				<div id="msg_success" class="blue"><%=success%></div>
				<button type="submit" class="btn btn-primary mt-2">Lưu</button>
				<a class="btn btn-secondary mt-2"
					href="<%=url%>/danh-muc-admin-controller?hanhDong=list&index=1">Huỷ</a>
			</form>
		</div>
	</div>
