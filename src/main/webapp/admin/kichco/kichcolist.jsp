			...
			<div>
				<div class="row">
					...
					<div class="col-auto">
						<a class="btn btn-primary"
							href="<%=url%>/admin/kichco/themkichco.jsp">Thêm kích cỡ</a>
					</div>
				...
				<table class="table">
					...
					<tbody class="table-group-divider">
						<%
						int i = 1;
						List<KichCo> listsKichCo = (ArrayList<KichCo>) request.getAttribute("listKichCo");
						%>
						<%
						for (KichCo kichCo : listsKichCo) {
						%>
						<tr>
							<th scope="row">
								<div class="form-check">
							...
							<td><%=kichCo.getMaKichCo()%></td>
							<td><%=kichCo.getTenKichCo()%></td>
							<td><a
								href="<%=url%>/kich-co-admin-controller?hanhDong=sua-kich-co&maKichCo=<%=kichCo.getMaKichCo()%>">
									<i class="bi bi-pencil"></i>
							</a> <a
								href="<%=url%>/kich-co-admin-controller?hanhDong=xoa-kich-co&maKichCo=<%=kichCo.getMaKichCo()%>"><i
				...
				<nav aria-label="Page navigation example">
					<ul class="pagination justify-content-end">
						...
						<li class="page-item"><a class="page-link"
							href="<%=url%>/kich-co-admin-controller?hanhDong=list&index=<%=index%>"><%=index%></a></li>
