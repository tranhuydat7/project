...
%>
	...
	<div class="row">
		...
		<div class="col-9 container">
			...
			<%
			KichCo kichCo = (KichCo) request.getAttribute("kichCo");
			%>

			<form action="<%=url%>/kich-co-admin-controller" method="get">
				<input type="hidden" name="hanhDong" value="save-kich-co" />
				<div>
					<label for="maKichCo" class="form-label">Mã kích cỡ <span
						class="red">*</span></label> <input type="text" class="form-control"
						id="maKichCo" name="maKichCo" value="<%=kichCo.getMaKichCo()%>" placeholder="Nhập mã kích cỡ"
						required>
					<div id="msg_maDanhMuc" class="red"><%=baoLoi%></div>
				</div>
				<div class="mb-3">
					<label for="tenKichCo" class="form-label">Tên kích cỡ <span
						class="red">*</span></label> <input type="text" class="form-control"
						id="tenKichCo" name="tenKichCo" value="<%=kichCo.getTenKichCo() %>" placeholder="Nhập tên kích cỡ"
						required>
				</div>
