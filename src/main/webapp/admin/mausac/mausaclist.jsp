		...
		<div class="col-9 container">
			...
			<div>
				<div class="row">
					...
					<div class="col-auto">
						<a class="btn btn-primary" href="<%=url%>/admin/mausac/themmausac.jsp">Thêm
							màu</a>
					</div>
				...
				<table class="table">
					...
					<tbody class="table-group-divider">
						<%
						int i = 1;
						List<Mau> listsMauSac = (ArrayList<Mau>) request.getAttribute("listMau");
						%>
						<%
						for (Mau mau : listsMauSac) {
						%>
						<tr>
							<th scope="row">
								<div class="form-check">
							...
							%>
							<a
								href="<%=url%>/mau-sac-admin-controller?hanhDong=sua-mau-sac&maMau=<%=maMauNew%>">
									<i class="bi bi-pencil"></i>
							</a> <a
								href="<%=url%>/mau-sac-admin-controller?hanhDong=xoa-mau-sac&maMau=<%=maMauNew%>"><i
				...
				<nav aria-label="Page navigation example">
					<ul class="pagination justify-content-end">
						...
						<li class="page-item"><a class="page-link"
							href="<%=url%>/mau-sac-admin-controller?hanhDong=list&index=<%=index%>"><%=index%></a></li>
